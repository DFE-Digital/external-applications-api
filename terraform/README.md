...
| <a name="input_data_protection_enable_storage"></a> [data\_protection\_enable\_storage](#input\_data\_protection\_enable\_storage) | Create a storage account and container to store key rings created by ASP.net | `bool` | `false` | no |
...
| <a name="input_data_protection_storage_account_ipv4_allow_list"></a> [data\_protection\_storage\_account\_ipv4\_allow\_list](#input\_data\_protection\_storage\_account\_ipv4\_allow\_list) | List of IPv4 addresses allowed to access the data protection storage account | `list(string)` | `[]` | no |
| <a name="input_data_protection_storage_account_vnet_subnet_ids_allow_list"></a> [data\_protection\_storage\_account\_vnet\_subnet\_ids\_allow\_list](#input\_data\_protection\_storage\_account\_vnet\_subnet\_ids\_allow\_list) | List of VNET subnet ids allowed to access the data protection storage account | `list(string)` | `[]` | no |
| <a name="input_data_protection_subnet_prefix"></a> [data\_protection\_subnet\_prefix](#input\_data\_protection\_subnet\_prefix) | Subnet prefix to use for the Data Protection Key Vault Private Endpoint | `string` | `"172.16.124.0/23"` | no |
...
| <a name="input_enable_signalr"></a> [enable\_signalr](#input\_enable\_signalr) | Enable serverless Azure SignalR service | `bool` | n/a | yes |
...
| <a name="input_mssql_extra_databases"></a> [mssql\_extra\_databases](#input\_mssql\_extra\_databases) | A map of extra database configurations (key is used as database name) | <pre>map(object({<br/>    sku_name : optional(string, "Basic"),<br/>    max_size_gb : optional(number, 2),<br/>    enable_extended_auditing_policy : optional(bool, true)<br/>  }))</pre> | `{}` | no |
...
| <a name="input_signalr_service_mode"></a> [signalr\_service\_mode](#input\_signalr\_service\_mode) | SignalR service mode | `string` | `"Default"` | no |
| <a name="input_signalr_sku"></a> [signalr\_sku](#input\_signalr\_sku) | SignalR SKU name | `string` | `"Free_F1"` | no |
