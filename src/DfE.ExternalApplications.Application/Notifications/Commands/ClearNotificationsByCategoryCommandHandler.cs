...
[RateLimit(5, 30)]
public sealed record ClearNotificationsByCategoryCommand(string Category) : IRequest<Result<Unit>>, IRateLimitedRequest;

public sealed class ClearNotificationsByCategoryCommandHandler(
    INotificationService notificationService,
    IPermissionCheckerService permissionCheckerService,
    IHttpContextAccessor httpContextAccessor)
    : IRequestHandler<ClearNotificationsByCategoryCommand, Result<Unit>>
{
