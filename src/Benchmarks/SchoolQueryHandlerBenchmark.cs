...
using ExternalApplications.Application.Common.Behaviours;
using ExternalApplications.Application.MappingProfiles;
...
using ExternalApplications.Infrastructure.Repositories;
using MediatR;
...
namespace ExternalApplications.Benchmarks
{
    [MemoryDiagnoser]
