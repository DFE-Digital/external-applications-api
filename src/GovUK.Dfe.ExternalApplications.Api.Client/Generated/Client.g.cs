...
namespace GovUK.Dfe.ExternalApplications.Api.Client
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.6.3.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class HostConfigClient : IHostConfigClient
    {
        #pragma warning disable 8618
        private string _baseUrl;
        #pragma warning restore 8618
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public HostConfigClient(string baseUrl, System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            BaseUrl = baseUrl;
            _httpClient = httpClient;
        ...
        /// <exception cref="ExternalApplicationsException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<HostConfigurationDto> GetHostConfigurationAsync(string target = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/host-config"
                    urlBuilder_.Append("v1/host-config");
                    urlBuilder_.Append('?');
                    if (target != null)
                    {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<HostConfigurationDto>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ExternalApplicationsException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ExternalApplicationsException<ExceptionResponse>("Invalid target.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
                        ...
                        if (status_ == 403)
                        {
                            ...
                            throw new ExternalApplicationsException<ExceptionResponse>("Missing Platform.Host.Read app role.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <exception cref="ExternalApplicationsException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<TemplateDto>> GetAccessibleTemplatesAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
        ...
        /// <exception cref="ExternalApplicationsException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<TemplateDto> CreateTemplateAsync(CreateTemplateRequest request, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (request == null)
                throw new System.ArgumentNullException("request");
        ...
        /// <exception cref="ExternalApplicationsException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<TemplateDto> SetTemplateLiveAsync(System.Guid templateId, SetTemplateLiveRequest request, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (templateId == null)
                throw new System.ArgumentNullException("templateId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/Templates/{templateId}/live"
                    urlBuilder_.Append("v1/Templates/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(templateId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/live");
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.6.3.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class TenantAdminClient : ITenantAdminClient
    {
        #pragma warning disable 8618
        private string _baseUrl;
        #pragma warning restore 8618
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public TenantAdminClient(string baseUrl, System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            BaseUrl = baseUrl;
            _httpClient = httpClient;
        ...
        public virtual async System.Threading.Tasks.Task<RefreshTenantConfigurationResponse> RefreshTenantConfigurationAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/admin/tenants/refresh"
                    urlBuilder_.Append("v1/admin/tenants/refresh");
        ...
        public virtual async System.Threading.Tasks.Task<GetTenantsResponse> GetTenantsAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/admin/tenants"
        ...
        public virtual async System.Threading.Tasks.Task<SeedTenantsResponse> SeedFromAppSettingsAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/admin/tenants/seed"
                    urlBuilder_.Append("v1/admin/tenants/seed");
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.6.3.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class TenantConfigClient : ITenantConfigClient
    {
        #pragma warning disable 8618
        private string _baseUrl;
        #pragma warning restore 8618
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public TenantConfigClient(string baseUrl, System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            BaseUrl = baseUrl;
            _httpClient = httpClient;
        ...
        /// <exception cref="ExternalApplicationsException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<TenantConfigurationDto> GetTenantConfigurationAsync(string target = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/tenant-config"
                    urlBuilder_.Append("v1/tenant-config");
                    urlBuilder_.Append('?');
                    if (target != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("target")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(target, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<TenantConfigurationDto>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ExternalApplicationsException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        if (status_ == 403)
                        {
                            ...
                            throw new ExternalApplicationsException<ExceptionResponse>("Principal is not registered to any tenant.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 404)
                        {
                            ...
                            throw new ExternalApplicationsException<ExceptionResponse>("Tenant inactive or no longer exists.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
        ...
        /// <returns>Tenant configuration.</returns>
        /// <exception cref="ExternalApplicationsException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<TenantConfigurationDto> GetTenantConfigurationByTenantIdAsync(System.Guid tenantId, string target = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (tenantId == null)
                throw new System.ArgumentNullException("tenantId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/tenant-config/tenants/{tenantId}"
                    urlBuilder_.Append("v1/tenant-config/tenants/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(tenantId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('?');
                    if (target != null)
                    {
                    ...
                    try
                    {
                        ...
                        if (status_ == 403)
                        {
                            ...
                            throw new ExternalApplicationsException<ExceptionResponse>("Missing Platform.TenantConfig.Read app role.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 404)
                        {
        ...
        /// <exception cref="ExternalApplicationsException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<TenantResolutionDto> ResolveTenantByHostnameAsync(string hostname = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/tenant-config/resolve"
                    urlBuilder_.Append("v1/tenant-config/resolve");
                    urlBuilder_.Append('?');
                    if (hostname != null)
                    {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<TenantResolutionDto>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ExternalApplicationsException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ExternalApplicationsException<ExceptionResponse>("Invalid hostname.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new ExternalApplicationsException<ExceptionResponse>("Hostname not mapped to any tenant.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
