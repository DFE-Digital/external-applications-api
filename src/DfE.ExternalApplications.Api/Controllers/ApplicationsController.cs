...
public class ApplicationsController(ISender sender) : ControllerBase
{
    ...
    /// </summary>
    [HttpPost]
    [Route(("{applicationId}/responses2"))]
    [SwaggerResponse(201, "Response version created.", typeof(ApplicationResponseDto))]
    [SwaggerResponse(400, "Invalid request data.")]
    [SwaggerResponse(401, "Unauthorized - no valid user token.")]
    [SwaggerResponse(403, "User does not have permission to update this application.")]
    [SwaggerResponse(404, "Application not found.")]
    [Authorize(Policy = "CanCreateAnyApplication")]
    public async Task<IActionResult> AddApplicationResponse2Async(
        [FromRoute] Guid applicationId,
        [FromBody] AddApplicationResponseRequest request,
        CancellationToken cancellationToken)
    {
    ...
    /// </summary>
    [HttpPost]
    [Route(("{applicationId}/responses3"))]
    [SwaggerResponse(201, "Response version created.", typeof(ApplicationResponseDto))]
    [SwaggerResponse(400, "Invalid request data.")]
    [SwaggerResponse(401, "Unauthorized - no valid user token.")]
    [SwaggerResponse(403, "User does not have permission to update this application.")]
    ...
    public async Task<IActionResult> AddApplicationResponse3Async(
        [FromRoute] Guid applicationId,
        [FromBody] AddApplicationResponseRequest request,
        CancellationToken cancellationToken)
    {
    ...
    /// </summary>
    [HttpPost]
    [Route(("{applicationId}/responses4"))]
    [SwaggerResponse(201, "Response version created.", typeof(ApplicationResponseDto))]
    [Authorize(Policy = "CanUpdateApplication")]
    public async Task<IActionResult> AddApplicationResponse4Async(
        [FromRoute] Guid applicationId,
        [FromBody] AddApplicationResponseRequest request,
        CancellationToken cancellationToken)
    {
    ...
    /// </summary>
    [HttpPost]
    [Route(("{applicationId}/responses5"))]
    [SwaggerResponse(201, "Response version created.", typeof(ApplicationResponseDto))]
    [Authorize(Policy = "CanUpdateApplication")]
    public async Task<IActionResult> AddApplicationResponse5Async(
        [FromRoute] Guid applicationId,
        CancellationToken cancellationToken)
    {
        var command = new AddApplicationResponseCommand(applicationId, "test from inside the method");
        var result = await sender.Send(command, cancellationToken);
