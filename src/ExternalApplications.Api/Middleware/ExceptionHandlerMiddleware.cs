...
using ExternalApplications.Api.ResponseModels;
using Microsoft.AspNetCore.Mvc;
using ValidationException = ExternalApplications.Application.Common.Exceptions.ValidationException;

namespace ExternalApplications.Api.Middleware;
