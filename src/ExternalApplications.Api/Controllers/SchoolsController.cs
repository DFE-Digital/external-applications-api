...
using ExternalApplications.Application.Common.Models;
using ExternalApplications.Application.Schools.Commands.CreateReport;
using ExternalApplications.Application.Schools.Commands.CreateSchool;
using ExternalApplications.Application.Schools.Queries.GetPrincipalBySchool;
using ExternalApplications.Application.Schools.Queries.GetPrincipalsBySchools;
using ExternalApplications.Domain.ValueObjects;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Swashbuckle.AspNetCore.Annotations;
using System.Net;
using ExternalApplications.Application.Common.Exceptions;
using ExternalApplications.Infrastructure.Security.Configurations;

namespace ExternalApplications.Api.Controllers
{
    [ApiController]
    [ApiVersion("1.0")]
