...
namespace DfE.ExternalApplications.Client.Contracts
{
    ...
    public partial interface IUsersClient
    {
        ...
        /// <br/>Returns all permissions for the user identified by {email}.
        /// </summary>
        /// <returns>A UserPermission object representing the User's Permissions.</returns>
        /// <exception cref="PersonsApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Principal> GetAllPermissionsForUserAsync(string email);
        ...
        /// <returns>A UserPermission object representing the User's Permissions.</returns>
        /// <exception cref="PersonsApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Principal> GetAllPermissionsForUserAsync(string email, System.Threading.CancellationToken cancellationToken);
