...
namespace DfE.ExternalApplications.Client
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <exception cref="PersonsApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Principal> GetAllPermissionsForUserAsync(string email)
        {
        ...
        /// <returns>A UserPermission object representing the User's Permissions.</returns>
        /// <exception cref="PersonsApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Principal> GetAllPermissionsForUserAsync(string email, System.Threading.CancellationToken cancellationToken)
        {
            if (email == null)
