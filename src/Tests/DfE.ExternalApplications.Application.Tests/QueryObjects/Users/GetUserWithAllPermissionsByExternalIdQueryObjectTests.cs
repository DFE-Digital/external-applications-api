...
public class GetUserWithAllPermissionsByExternalIdQueryObjectTests
{
    [Theory]
        ...
        string externalProviderId)
    {
        ...
        var queryObject = new GetUserWithAllPermissionsByExternalIdQueryObject(externalProviderId);
