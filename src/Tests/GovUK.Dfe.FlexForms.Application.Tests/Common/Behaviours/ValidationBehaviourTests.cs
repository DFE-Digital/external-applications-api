...
using NSubstitute;
using Xunit;
using ValidationException = GovUK.Dfe.FlexForms.Application.Common.Exceptions.ValidationException;

namespace GovUK.Dfe.FlexForms.Application.Tests.Common.Behaviours;
