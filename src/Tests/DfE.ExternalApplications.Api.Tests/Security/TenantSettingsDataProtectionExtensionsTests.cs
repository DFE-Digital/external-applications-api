...
public class TenantSettingsDataProtectionExtensionsTests
{
    ...
    [InlineData("Local")]
    public void AddTenantSettingsDataProtection_LocalOrDevelopment_UsesLocalKeysEvenWhenUseAzureTrue(string environmentName)
    {
    ...
    private static IConfiguration BuildConfiguration(bool useAzure, string blobUri, string keyVaultKeyId) =>
        new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["DataProtection:ApplicationName"] = "DfE.ExternalApplications.Api.Tests",
