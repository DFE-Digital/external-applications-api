...
using ExternalApplications.Api;
using ExternalApplications.Api.Client.Extensions;
using ExternalApplications.Client;
using ExternalApplications.Client.Contracts;
using ExternalApplications.Infrastructure.Database;
using ExternalApplications.Tests.Common.Seeders;
...
namespace ExternalApplications.Tests.Common.Customizations
{
